...
/*# sourceMappingURL=project.css.map*/
        ...
        <table>
            <tr>
                ...
                <asp:Button ID="back" runat="server" Text="Back" OnClick="back_Click" CssClass="uiButton private-button private-button--tertiary private-button--xs private-button--non-link" />
            </tr>
            <tr>
                <asp:DataList ID="projList" runat="server" CellPadding="4">
                        <ItemTemplate>
                            <tr>
                                <th colspan="2"></th>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="proj_desc" runat="server" TextMode="MultiLine" Height="75" Text='<%# Eval("description") %>' ReadOnly="true" Enabled="false" />
                                </td>
                            
                                <td>Other Notes:
                                </td>
                                <td>
                                    <asp:TextBox ID="notes" TextMode="MultiLine" runat="server" Text='<%# Eval("note") %>' Height="150" Width="300" ReadOnly="true" Enabled="false" />
                                    <asp:Button ID="projSave" runat="server" Text="Save" Visible="false" Enabled="false" OnClick="projSave_Click" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
                                    <asp:Button ID="projEdit" runat="server" Text="Edit" OnClick="projEdit_Click" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
                                </td>
                            </tr>
            ...
            <tr>
                <td>
                    ...
                    <asp:Button ID="add" Visible="true" Enabled="true" Text="Add/Search" runat="server" OnClick="add_Click" CssClass="uiButton private-button private-button--primary private-button--sm add-obj private-button--non-link" />
                    <asp:Button ID="submit" Text="Submit" runat="server" OnClick="submit_Click" Visible="false" Enabled="false" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
                    ...
                    <asp:Button ID="searchAddSubmit" runat="server" OnClick="searchAddSubmit_Click" Visible="false" Enabled="false" Text="Search" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
