...
<body>  
    ...
    <h1 class="private-header__heading private-header__heading--solo">Projects</h1>  
            ...
            <table style="width:100%;">  
                ...
                <tr>  
                    ...
                    <td> 
                            ...
                            <asp:Button ID="newProjTrigger" Text="New Project" runat="server" OnClick="newProjbutt" CssClass="uiButton private-button private-button--primary private-button--sm add-obj private-button--non-link" />
                            <asp:Button ID="submitButton" Text="Submit" runat="server" OnClick="subButt" Visible="false" Enabled="false" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
                            ...
                            <br/>
                            <asp:TextBox ID="searchbar" Text="Search Query" runat="server" class="FilterBar__FilterBarSectionGeneric-sc-1pq4ioh-2 FilterBar__Start-sc-1pq4ioh-3 oBwUy"></asp:TextBox>
                            <asp:Button ID="searchbutton" Text="Search" runat="server" OnClick="searchbutton_Click" CssClass="uiButton private-button private-button--secondary private-button--sm private-button--non-link" />
